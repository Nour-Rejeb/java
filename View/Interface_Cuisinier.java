...
public class Interface_Cuisinier extends JFrame {

	private static final long serialVersionUID = 1L;
	private JPanel contentPane;

	public Interface_Cuisinier() {
		setTitle("Espace_Cuisinier");
		...
		btnNewButton.setIcon(new ImageIcon(Interface_Cuisinier.class.getResource("/images/user (4).png")));
		...
		contentPane.add(btnNewButton_31); // <- AJOUT DU BOUTON
		...
		btnNewButton_5.setIcon(new ImageIcon(Interface_Cuisinier.class.getResource("/images/logout.png")));
		btnNewButton_5.setFont(new Font("Tahoma", Font.BOLD, 30));
		contentPane.add(btnNewButton_5);
		
		JLabel lblNewLabel = new JLabel("Espace_Cuisinier");
		...
		btnNewButton_1.setIcon(new ImageIcon(Interface_Cuisinier.class.getResource("/images/button.png")));
