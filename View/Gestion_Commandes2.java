...
public class Gestion_Commandes2 extends JFrame {
	...
	public Gestion_Commandes2() {
        ...
        btnSupprimer.addActionListener(e -> {
            try {
                int num = Integer.parseInt(num_cField.getText());
                commandeDAO.supprimerCommande(num);
                reloadCommandeData();
    ...
    private void reloadCommandeData() {
        try {
			model_Commande.loadData(commandeDAO.getToutesLesCommandes());
		} catch (SQLException e) {
			// TODO Auto-generated catch block
