...
public class Gestion_Menus2 extends JFrame {
    ...
    private void reloadMenuData() throws SQLException {
        modelMenu.loadData(menuDAO.getAll());
		table.setModel(modelMenu);
    }

    @SuppressWarnings("unused")
	public Gestion_Menus2() throws SQLException {
        setTitle("Menus");
        ...
        lblTitle.setIcon(new ImageIcon(Gestion_Menus2.class.getResource("/images/client.png")));
