...
public class Gestion_Menus extends JFrame {
	...
	public Gestion_Menus() {
        ...
        lblTitle.setIcon(new ImageIcon(Gestion_Menus.class.getResource("/images/client.png")));
        ...
        btnAjouter.addActionListener(e -> {
            ...
            String nom_m = nomMenuField.getText();
            Menu menu = new Menu(id, nom_m, new ArrayList<Plat>());
            try {
